...
import si.triglav.common.propchar.properties.PinEzivljenje;
...
public class PinEzivljenje_7874_Mapper implements PropertyMapper<PinEzivljenje> {
    ...
    @Override
    public void updateList(PinEzivljenje obj, List<PCharacteristicVAO> characteristics) {
        updateOrAdd(characteristics, 7873, obj.getPinEzivljenje(), "desc");
    }
