...
import si.triglav.common.propchar.properties.ZaposlitevStatus;
...
public class ZaposlitevStatus_7745_Mapper implements PropertyMapper<ZaposlitevStatus> {
    ...
    @Override
    public void updateList(ZaposlitevStatus obj, List<PCharacteristicVAO> characteristics) {
        updateOrAdd(characteristics, 7809, obj.getStatusZaposlitve(), "number");
    }
