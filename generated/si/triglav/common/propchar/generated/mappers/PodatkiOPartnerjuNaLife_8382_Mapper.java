...
import si.triglav.common.propchar.properties.PodatkiOPartnerjuNaLife;
...
public class PodatkiOPartnerjuNaLife_8382_Mapper implements PropertyMapper<PodatkiOPartnerjuNaLife> {
    ...
    @Override
    public void updateList(PodatkiOPartnerjuNaLife obj, List<PCharacteristicVAO> characteristics) {
        updateOrAdd(characteristics, 8383, obj.getPartnerImaSklenjenoVeljavnoOsebnoZavarovanje(), "number");
    }
