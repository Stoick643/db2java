...
import si.triglav.common.propchar.properties.KontaktSpletniNaslov;
...
public class KontaktSpletniNaslov_7743_Mapper implements PropertyMapper<KontaktSpletniNaslov> {
    ...
    @Override
    public void updateList(KontaktSpletniNaslov obj, List<PCharacteristicVAO> characteristics) {
        updateOrAdd(characteristics, 7804, obj.getSpletniNaslov(), "desc");
    }
