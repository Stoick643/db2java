...
import si.triglav.common.propchar.properties.OpravljenPoglobljenPregled;
...
public class OpravljenPoglobljenPregled_8371_Mapper implements PropertyMapper<OpravljenPoglobljenPregled> {
    ...
    @Override
    public void updateList(OpravljenPoglobljenPregled obj, List<PCharacteristicVAO> characteristics) {
        updateOrAdd(characteristics, 8372, obj.getOpravljenPoglobljenPregled(), "number");
    }
