...
import si.triglav.common.propchar.properties.IdentifikacijskaKodaEuid;
...
public class IdentifikacijskaKodaEuid_13682_Mapper implements PropertyMapper<IdentifikacijskaKodaEuid> {
    ...
    @Override
    public void updateList(IdentifikacijskaKodaEuid obj, List<PCharacteristicVAO> characteristics) {
        updateOrAdd(characteristics, 13683, obj.getIdentifikacijskaKodaEuid(), "desc");
    }
