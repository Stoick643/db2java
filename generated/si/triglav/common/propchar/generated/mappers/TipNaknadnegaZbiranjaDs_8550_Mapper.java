...
import si.triglav.common.propchar.properties.TipNaknadnegaZbiranjaDs;
...
public class TipNaknadnegaZbiranjaDs_8550_Mapper implements PropertyMapper<TipNaknadnegaZbiranjaDs> {
    ...
    @Override
    public void updateList(TipNaknadnegaZbiranjaDs obj, List<PCharacteristicVAO> characteristics) {
        updateOrAdd(characteristics, 8551, obj.getTipNaknadnegaZbiranjaDs_number(), "number");
        updateOrAdd(characteristics, 8551, obj.getTipNaknadnegaZbiranjaDs_desc(), "desc");
    }
