...
import si.triglav.common.propchar.properties.Province;
...
public class Province_13684_Mapper implements PropertyMapper<Province> {
    ...
    @Override
    public void updateList(Province obj, List<PCharacteristicVAO> characteristics) {
        updateOrAdd(characteristics, 13685, obj.getProvince(), "number");
    }
