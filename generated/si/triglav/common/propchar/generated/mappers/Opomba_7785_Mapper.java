...
import si.triglav.common.propchar.properties.Opomba;
...
public class Opomba_7785_Mapper implements PropertyMapper<Opomba> {
    ...
    @Override
    public void updateList(Opomba obj, List<PCharacteristicVAO> characteristics) {
        updateOrAdd(characteristics, 7832, obj.getOpisOpombe(), "desc");
    }
