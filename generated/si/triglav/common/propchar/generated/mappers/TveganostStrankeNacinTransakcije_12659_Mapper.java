...
import si.triglav.common.propchar.properties.TveganostStrankeNacinTransakcije;
...
public class TveganostStrankeNacinTransakcije_12659_Mapper implements PropertyMapper<TveganostStrankeNacinTransakcije> {
    ...
    @Override
    public void updateList(TveganostStrankeNacinTransakcije obj, List<PCharacteristicVAO> characteristics) {
        updateOrAdd(characteristics, 12660, obj.getTveganostStrankeNacinTransakcije(), "number");
    }
