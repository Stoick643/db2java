...
import si.triglav.common.propchar.properties.MednarodnaIdentifikacijskaKoda;
...
public class MednarodnaIdentifikacijskaKoda_13669_Mapper implements PropertyMapper<MednarodnaIdentifikacijskaKoda> {
    ...
    @Override
    public void updateList(MednarodnaIdentifikacijskaKoda obj, List<PCharacteristicVAO> characteristics) {
        updateOrAdd(characteristics, 13670, obj.getMednarodnaIdentifikacijskaKoda(), "desc");
    }
