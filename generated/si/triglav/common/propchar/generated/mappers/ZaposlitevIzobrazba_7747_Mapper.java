...
import si.triglav.common.propchar.properties.ZaposlitevIzobrazba;
...
public class ZaposlitevIzobrazba_7747_Mapper implements PropertyMapper<ZaposlitevIzobrazba> {
    ...
    @Override
    public void updateList(ZaposlitevIzobrazba obj, List<PCharacteristicVAO> characteristics) {
        updateOrAdd(characteristics, 7811, obj.getStopnjaIzobrazbe(), "number");
    }
